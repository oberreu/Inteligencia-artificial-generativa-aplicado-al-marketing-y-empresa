...
**Imagen destacada (concepto + prompt reproducible, alineado a la línea visual de Vuela.ai):**
- *Concepto:* escena moderna y luminosa tipo "cómo hacer" de Vuela.ai: un avión de papel (guiño a "Vuela") que traza una ruta sobre una grilla de controles del CCM y el contorno de Chile, sugiriendo "despegar hacia el cumplimiento". Estilo marketing vibrante, no corporativo-sobrio.
- *Paleta:* degradados violeta–azul de marca Vuela sobre fondo claro, acentos en celeste; ilustración flat/3D suave, amable y dinámica (coherente con las portadas de su blog).
- *Prompt (Vuela.ai / Gemini, 16:9):* `Ilustración de blog moderna y vibrante, estilo marketing tech: un avión de papel dejando una estela que recorre una grilla luminosa de controles de seguridad sobre el contorno estilizado de Chile y un ícono de nube. Degradados violeta y azul sobre fondo claro, acentos celeste, estilo flat 3D suave, dinámico y optimista, alta nitidez, composición con espacio para titular. Sin texto.`
...
Si tu empresa opera en la nube, probablemente ya está, sin saberlo, a mitad de camino de varios de los 17 dominios del CCM. No inventa controles nuevos: ordena lo que ya deberías tener y lo conecta con ISO 27001, NIST y el RGPD, estándares con los que la 21.719 está alineada.
...
| **Línea visual** | Moderna, vibrante, degradados de marca, motivo "vuela" | Imagen destacada con avión de papel + degradados violeta-azul (ver sección 3) |
